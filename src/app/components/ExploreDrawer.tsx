...
export default function ExploreDrawer({ open, onClose }: ExploreDrawerProps) {
  const menuItems = [
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-[100] h-screen transition-transform duration-300 ease-in-out
        ...
        w-[390px] bg-black/30 backdrop-blur-lg border-r border-white/30 shadow-2xl flex flex-col
        rounded-r-xl hidden sm:flex
      `}
      style={{
